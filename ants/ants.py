    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            if self.is_container() and self.can_contain(place.ant):
                ...
                place.ant = self
            elif place.ant.can_contain(self) and place.ant.contained_ant is None:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while not place.is_hive():
            if self.min_range <= dist <= self.max_range and place.bees:
        ...
        if self.impostor:
            ...
            while curr_place is not None:
                ...
                if isinstance(curr_place.ant, ContainerAnt) and curr_place.ant.contained_ant:
                    if not curr_place.ant.contained_ant.damage_doubled:
