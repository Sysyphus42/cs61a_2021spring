...
def distance(city_a, city_b):
    ...
    b_1 = get_lat(city_b)
    b_2 = get_lon(city_b)
    return sqrt((a_1 - b_1) ** 2 + (a_2 - b_2) ** 2)
...
def add_trees(t1, t2):
    ...
    4
      ...
      5
    """
    b = [add_trees(b1, b2) for b1,b2 in zip(branches(t1), branches(t2))]
    i = len(b)
    rest = branches(t1)[i:] + branches(t2)[i:]
    return tree(label(t1) + label(t2), b + rest)
